  ...
  const renderCard = () => users.map(user => (
    <div className="bg-gray-300 p-5 flex items-center justify-between" key={user.id}>
      <div>
        ...
        <h3 className="text-lg text-gray-700">Age: {user.age}</h3>
        <h3 className="text-lg text-gray-700">Gender: {user.gender}</h3>
        <span className="font-normal text-gray-600">Height: {user.height}cm</span>
